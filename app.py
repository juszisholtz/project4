...
def run_model_for_ticker(ticker_symbol):
    try:
        ...
        return report, statement, disclaimer
...
def index():
    ...
    if request.method == "POST":
        ...
        result, statement, disclaimer = run_model_for_ticker(ticker)
    return render_template("index.html", result=result, statement=statement, disclaimer=disclaimer, ticker=selected_ticker)
